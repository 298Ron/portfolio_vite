    ...
    <>
      <Container style={{ textAlign: "center", paddingTop: "70px" }} id="about">
        ...
        <div className="row mb-5 text-dark" style={{ textAlign: "center" }}>
          ...
          <div className="col-lg-3  mt-3">
            <img
              ...
              alt="profile picture"
              style={{ width: "315px", borderRadius: "50px" }}
            />
          </div>
          ...
          <div className="col-lg-6 ">
            ...
            <p className="col-md-8 m-auto fs-5">
              {" "}
              🔒Passionate 22 y.o Full-Stack Web Developer with a dynamic skill
              set, My journey into the tech realm was shaped by a commitment to
              communication, meticulous attention to details, and a
              collaborative teamwork ethos. 🎓Having successfully completed the
              rigorous FullStack Developer program at HackerU. 🚀 Beyond the
              code, my holistic approach to development integrates personal
              qualities that have been integral to my achievements, fostering an
              environment where creativity meets precision in the ever-evolving
              landscape of web development.🌐#WebDeveloper #Full-Stack
            </p>
          </div>
          {/* THE LANGUAGES */}
          <div className="col-lg-3 mt-3">
            <div className="row ">
              ...
              {languages.map((language) => (
                <div className="col-6 m-auto zoomIn my-3" key={language.img}>
                  <img src={language.img} alt={language.img} width={"50%"} />
                </div>
              ))}
            </div>
          </div>
        </div>
        <Link to={`/cv/Ron-Shilimov-CV.pdf`} target="_blank" download>
          <button className="btn some some p-3 mb-5 zoomOut " id="gallery">
            DOWNLOAD RESUME
          </button>
        </Link>
        ...
        <div className="" style={{ position: "relative" }}>
          ...
          <form
            className="form row col-xl-5 m-auto"
            id="myForm"
            onSubmit={(e) => {
              sendEmail(e);
          ...
          >
            <div className="form-floating ">
              <input
                ...
                placeholder="Name"
              />
              <label htmlFor="name" className="ms-4 text-dark">
                Name
              </label>
            ...
            <div className="form-floating ">
              <input
                ...
                placeholder="Email"
              />
              <label htmlFor="email" className="ms-4 text-dark">
                Email
              </label>
            ...
            <div className="form-floating ">
              <textarea
                className="text-dark  form-control shadow mb-2"
                id="floatingmessage"
                name="message"
            ...
            <div className="my-2 ">
              <button
                className="btn btn-secondary col-12 my-2 zoomIn2"
                type="submit"
              >
                SUBMIT
              </button>
